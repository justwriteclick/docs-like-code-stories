# 10 tips for maintaining a long-term relationship with docs like code

##### By Gary Niemen, Product Manager for TechDocs, Spotify’s docs-like-code solution

I remember about two years ago sitting here (well, not precisely “here” because we sat in offices in those days) watching, wide-eyed and a bit confused, a video of [Riona MacNamara’s talk from Write the Docs 2015](https://youtu.be/EnB8GtPuauw). In the talk, Riona described how she and another technical writer used a docs-like-code approach to change Google engineering culture around technical documentation.
...
And just a few months later, we had built and released TechDocs, Spotify’s docs-like-code solution. And a few months after that, we had the curve that I had longed for. Nice gradient, eh?
